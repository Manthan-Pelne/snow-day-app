...
const page = () => {
  return (
   ...
   <ul>
      ...
      <li>
         <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to snow day prediction.</p>
      </li>
      <li>
      ...
      <li>
         <p><strong>Website</strong> refers to snow day prediction, accessible from <a href="https://snow day prediction.io" rel="external nofollow noopener" target="_blank">https://snow day prediction.io</a></p>
      </li>
      <li>
   ...
   <ul>
      <li>By email: support@snow day prediction.io</li>
   </ul>
</article>
    </Typography>
    </>
