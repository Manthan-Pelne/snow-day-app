  ...
  return (
    <section className="max-w-screen-2xl mx-auto ">
      ...
      <div className="max-w-7xl mx-auto mt-30">
        <div class=" min-h-[75px] w-full py-[10px] px-[30px] md:px-[50px] flex flex-col items-center justify-center">
          <div class=" mb-[50px] mx-auto flex flex-col-reverse md:flex-row-reverse items-center justify-center max-w-[1320px] w-full gap-10 md:gap-0">
            <div class="relative pattern-dots-md w-full md:w-1/2">
              <img
                class="w-full transform -translate-x-6 translate-y-6 h-auto rounded-[10px] drop-shadow-2xl"
                src="/calc.png"
                alt="Main"
              />
              <div
                class="bg-[#141452] p-5 rounded-[10px] flex flex-col items-start max-w-[430px] 
                  static md:absolute md:bottom-[-55px] md:left-[-12%] 
                  mt-0 md:mt-0 z-10"
              >
                <p class="text-white text-base  leading-[22px] md:leading-[26px] mb-2.5">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget
                  purus lectus viverra in semper nec pretium mus.
                </p>
                <img
                  class="w-[55%] md:w-auto mt-3"
            ...
            <div class="w-full md:w-[40%] flex flex-col items-start justify-start md:mr-10 py-0 pr-[15px] pl-0 mt-[100px] md:mt-0">
              <p class="text-[#4d4d7a] underline underline-offset-8 text-3xl font-extrabold leading-[30px] mb-6 p-0">
                About Calculator
              </p>
              <p class="text-[#939191] italic text-xl md:text-xl font-bold leading-7 md:leading-8 mb-2 p-0">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
              <p class="text-[#777171] text-base  font-normal leading-[22px] md:leading-[26px] mb-[50px] p-0">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              ...
              <a
                href="#"
                class="inline-block text-[#666666] rounded-lg text-base leading-7 border-2 border-[#666666] py-2 px-10 bg-white transition-colors duration-300 hover:bg-[#b062ff] hover:text-white hover:border-transparent cursor-pointer"
              >
                View More
              </a>
            </div>
        ...
        <div className="mt-10 gap-6">
          {/* <div className="w-[700px] shadow-2xl rounded-2xl">
              <img 
              src="/calc.png"
