            ...
            <>
              ...
              <motion.div
                ...
                style={{
                  ...
                  background: `linear-gradient(to bottom, #22d3ee, #22d3ee, #447EB3)`,
              ...
              >
                <motion.div
                  className="w-3 h-3 rounded-full" // Size of the comet core
                  style={{
                    background:
                      "radial-gradient(circle, rgba(168,85,247,0.8) 0%, rgba(99,102,241,0.5) 40%, #5890f1 70%)",
                    // Intense, layered glow effect for the comet
                    boxShadow: `
                      0 0 15px 4px #5890f1,
                      0 0 5px 8px #5890f1,
                      0 0 40px 15px #5890f1
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
